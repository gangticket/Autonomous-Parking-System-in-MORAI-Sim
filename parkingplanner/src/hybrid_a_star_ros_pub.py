...
class hybrid_a_star_path_pub:
    ...
    def calc_hybrid_a_star_path_node(self, epsilon_pos = 3.0, epsilon_yaw = np.pi * 2):
        opt_path = a_star(self.start_state, self.goal_state, self.space, self.obstacle_list, epsilon_pos, epsilon_yaw, R=4.0, Vx=2.0, delta_time_step=0.5, weight=0.1)
        ...
        plt.legend()
        plt.savefig('/home/ubuntu/cmaker_ws/src/parkingplanner/data/image.png')
        print("save image!!!!!!!!")
